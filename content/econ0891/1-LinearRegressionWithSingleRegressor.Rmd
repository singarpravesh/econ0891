...
# Contents
[1.1 Introduction](#one-one)<br>
[1.2 Linear Regression](#one-two)<br>
[1.3 The OLS estimator](#one-three)<br>
[1.4 Measures of fit](#one-four)<br>
[1.5 The sensitivity of OLS to large outliers](#one-five)<br>
[1.6 Exercise](#one-six)



# 1.1 Introduction {#one-one}
...
Download the dataset [caschool.xlsx](caschool.xlsx) and the [description](californiatestscores.docx){target="_blank"}
...
# 1.3 The OLS estimator {#one-three}
...
# 1.5 The sensitivity of OLS to large outliers. {#one-five}
